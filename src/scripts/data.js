...
const hotelsData = [
  {
    ...
    availabilityTo: moment().add(10, 'd').format("YYYY-MM-DD"), // 10 days
    rooms: 11,
    city: 'Buenos Aires',
    country: 'Argentina',
    price: 4
  },
  {
    ...
    availabilityFrom: moment().add(10, 'd').format("YYYY-MM-DD"), // 10 days
    availabilityTo: moment().add(15, 'd').format("YYYY-MM-DD"), // 15 days
    rooms: 23,
    city: 'Mar del Plata',
    country: 'Argentina',
    price: 2
  },
  {
    ...
    availabilityFrom: moment().add(5, 'd').format("YYYY-MM-DD"), // 5 days
    availabilityTo: moment().add(15, 'd').format("YYYY-MM-DD"), // 15 days
    rooms: 16,
    city: 'Mendoza',
    country: 'Argentina',
  ...
  },
  {
    ...
    availabilityFrom: moment().add(20, 'd').format("YYYY-MM-DD"), // 20 days
    availabilityTo: moment().add(30, 'd').format("YYYY-MM-DD"), // 30 days
    rooms: 32,
    city: 'Jujuy',
    country: 'Argentina',
    price: 1
  },
  {
    ...
    availabilityFrom: moment().format("YYYY-MM-DD"),
    availabilityTo: moment().add(5, 'd').format("YYYY-MM-DD"), // 5 days
    rooms: 14,
    city: 'Salta',
    country: 'Argentina',
    price: 2
  },
  {
    ...
    availabilityFrom: moment().add(15, 'd').format("YYYY-MM-DD"), // 15 days 
    availabilityTo: moment().add(30, 'd').format("YYYY-MM-DD"), // 30 days
    rooms: 16,
    city: 'Córdoba',
    country: 'Argentina',
  ...
  },
  {
    ...
    availabilityFrom: moment().add(30, 'd').format("YYYY-MM-DD"), // 30 days
    availabilityTo: moment().add(40, 'd').format("YYYY-MM-DD"), // 40 days
    rooms: 40,
  ...
  },
  {
    ...
    availabilityFrom: moment().add(10, 'd').format("YYYY-MM-DD"), // 10 days
    availabilityTo: moment().add(20, 'd').format("YYYY-MM-DD"), // 20 days
    rooms: 21,
    city: 'Pucón',
    country: 'Chile',
    price: 4
  ...
  },
  {
    ...
    availabilityFrom: moment().add(25, 'd').format("YYYY-MM-DD"), // 25 days
    availabilityTo: moment().add(30, 'd').format("YYYY-MM-DD"), // 30 days
    rooms: 4,
    city: 'Colonia',
    country: 'Uruguay',
